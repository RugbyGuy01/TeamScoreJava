...
class HoleStokeDetails {
    private TextView m_tvScoreCell;      // the score card screen text views are zero based
  ...
  */
    private HoleStokeDetails(TextView CellPointer) {
        m_tvScoreCell = CellPointer;         // text view for the score
        ClearHoleDetails();
    }

    private HoleStokeDetails() {
        ClearHoleDetails();
    }
     ...
     */
    private byte getQuotaHoleScore() {
     ...
     */
    private void setQuotaHoleScore(byte QuotaHoleScore) {
     ...
     */
    private void setPlayerGrossScore(byte GrossHoleScore) {
    ...
    */
     ...
     */
    private void setTeamHoleMask(byte TeamMask) {
     ...
     */
    private void setStrokeForHole(byte ShotsForHole) {
     ...
     */
    private byte getNumberOfShotsForThisHole() {
    ...
    /*
         ...
         */
    private int getStrokeBackgroundColor() {
    ...
    /*
      ...
      */
    private int DisplayScoreCardScore(int displayMode, byte parForHole) {
        int ScoreValue = 0;
